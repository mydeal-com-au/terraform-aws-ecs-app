resource "aws_ecs_service" "default" {
  ...
  iam_role                           = !var.alb || var.launch_type == "FARGATE" ? null : var.service_role_arn
  ...
  launch_type                        = length(var.ecs_service_capacity_provider_strategy) == 0 ? var.launch_type : null
